...
#define IS_FULL_SPEED_USB(Adapter)	(Adapter->dvobj->usb_speed == RTW_USB_SPEED_1_1)
#define IS_HIGH_SPEED_USB(Adapter)	(Adapter->dvobj->usb_speed == RTW_USB_SPEED_2)
#define IS_SUPER_SPEED_USB(Adapter)	(Adapter->dvobj->usb_speed == RTW_USB_SPEED_3)
